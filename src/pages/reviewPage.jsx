      ...
      <div className="w-full max-w-6xl mx-auto px-4 py-10 lg:py-14">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-10">
          <div>
            ...
            <p className="mt-3 text-sm lg:text-base text-secondary/80 max-w-xl">
              Share your experience about our gaming laptops, custom PCs and
              accessories – your feedback helps us improve.
            </p>
          </div>

          <div className="bg-white/80 backdrop-blur-sm rounded-2xl px-5 py-4 shadow-md border border-white/60 min-w-[200px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,1.4fr)] gap-10">
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-white/70">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* <div>
                ...
                <input
                  type="text"
                  className="w-full rounded-xl border border-gray-300 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-accent/40"
                  placeholder={
                    user
              ...
              <div>
                ...
                <textarea
                  className="w-full min-h-[140px] rounded-xl border border-gray-300 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-accent/40"
          ...
          {/* Review list */}
          <div className="bg-white/70 rounded-2xl shadow-inner border border-white/60 p-4 lg:p-5 max-h-[500px] overflow-y-auto">
            {loading && (
            ...
            {!loading &&
              reviews.map((review) => (
                <div
                  key={review.reviewId}
                  className="bg-white border border-gray-100 rounded-2xl p-4 mb-3 shadow-sm hover:bg-black/5 transition-colors"
                >
                  ...
                  {review.comment && (
                    <p className="mt-3 text-sm text-secondary/80 text-justify">
                      {review.comment}
                    </p>
                  )}
                </div>
