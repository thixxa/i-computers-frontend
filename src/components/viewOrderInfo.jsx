            ...
            >
                ...
                <div className="bg-white w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
                    ...
                    <div className="bg-gray-50 px-6 py-4 border-t border-gray-200 flex justify-end gap-3">
                        ...
                        {
                            (order.status !== status || order.notes !== notes) && // Show Save Changes button only if there are changes
                            <button 
                                onClick={()=>{
                                ...
                                className="px-4 py-2 text-sm font-medium text-white bg-accent/60 hover:bg-accent rounded-lg shadow-sm transition-all flex items-center gap-2">
                                Save Changes
                            </button>
                        }
                    </div>
